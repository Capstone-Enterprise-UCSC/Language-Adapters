...
def get_tokenized_dataset(dataset_root_path, src_lang, tgt_lang, tokenizer, args):
...
def get_processed_dataset(dataset_root_path, src_langs, tgt_langs, tokenizer, args):
